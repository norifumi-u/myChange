...
public final class MyChange_D1_1 extends org.scribble.runtime.statechans.BranchSocket<MyChange, D1> implements Branch_D1_C_change__C_exit__C_save1<MyChange_D1_1, EndSocket, MyChange_D1_1> {
	...
	public MyChange_D1_1_Cases branch(C role) throws org.scribble.main.ScribRuntimeException, IOException, ClassNotFoundException {
		...
		Branch_D1_C_change__C_exit__C_save1_Enum openum;
		if (m.op.equals(MyChange.change)) {
			openum = Branch_D1_C_change__C_exit__C_save1_Enum.change;
		}
		else if (m.op.equals(MyChange.save1)) {
			openum = Branch_D1_C_change__C_exit__C_save1_Enum.save1;
		}
		else if (m.op.equals(MyChange.exit)) {
			openum = Branch_D1_C_change__C_exit__C_save1_Enum.exit;
		}
		else {
	...
	public void branch(C role, MyChange_D1_1_Handler handler) throws org.scribble.main.ScribRuntimeException, IOException, ClassNotFoundException {
		branch(role, (Handle_D1_C_change__C_exit__C_save1<MyChange_D1_1, EndSocket, MyChange_D1_1>) handler);
	}

	@Override
	public void branch(C role, Handle_D1_C_change__C_exit__C_save1<MyChange_D1_1, EndSocket, MyChange_D1_1> handler) throws org.scribble.main.ScribRuntimeException, IOException, ClassNotFoundException {
		org.scribble.runtime.message.ScribMessage m = super.readScribMessage(MyChange.C);
		if (m.op.equals(MyChange.change)) {
			handler.receive(new MyChange_D1_1(this.se, true), MyChange.change);
		}
		else
		if (m.op.equals(MyChange.save1)) {
			handler.receive(new MyChange_D1_1(this.se, true), MyChange.save1);
		}
		else
	...
	@Override
	public void handle(C role, Handle_D1_C_change__C_exit__C_save1<Succ_In_C_change, Succ_In_C_exit, Succ_In_C_save1> handler) throws org.scribble.main.ScribRuntimeException, IOException, ClassNotFoundException {
		org.scribble.runtime.message.ScribMessage m = super.readScribMessage(MyChange.C);
		if (m.op.equals(MyChange.change)) {
			handler.receive(new MyChange_D1_1(this.se, true), MyChange.change);
		}
