...
public final class MyChange_S_1 extends org.scribble.runtime.statechans.OutputSocket<MyChange, S> implements Select_S_D2_save2<MyChange_S_1> {
	...
	public MyChange_S_1 send(D2 role, save2 op) throws org.scribble.main.ScribRuntimeException, IOException {
		super.writeScribMessage(role, MyChange.save2);
